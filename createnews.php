...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    {
        $sql = "INSERT INTO info_news (news_title, news_short_description, news_full_content, news_author,news_published_on) VALUES (?, ?, ?, ?, ?)";
 
        if($stmt = $mysqli->prepare($sql))
        {
            
           $stmt->bind_param("sssss",$param_title, $param_shortdesc, $param_fulldesc, $param_author,$param_date);
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>Please fill all blanks to add news to the database.</p>
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <input type="submit" class="btn btn-primary" value="Submit" style="background:goldenrod">
